...
# 使用PM2启动服务（指定完整路径）
pm2 start /home/project/python-ncm-mp3/server.js --name ncm-converter
```
...
**解决方案**: 
- 确保在正确的项目目录下：`cd /home/project/python-ncm-mp3`
- 或使用完整路径：`pm2 start /home/project/python-ncm-mp3/server.js`
